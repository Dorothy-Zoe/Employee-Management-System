        ...
        if (!empty($employee_id) && !empty($password)) {
            ...
            if ($result->num_rows == 1) {
                ...
                if (password_verify($password, $row['Password'])) {
                    $_SESSION['employee_user'] = $row['EmployeeID'];
                    header("Location: instructorDashboard.php"); // Redirect to faculty Dashboard
                    exit();
                } else {
...
<body>
    ...
    <div class="container">
      ...
      <form action="instructor.php" method="POST">
          ...
          <input type="text" name="employee_id" id="employee_id" placeholder="User ID" required>
